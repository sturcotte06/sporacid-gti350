...
public class SwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
	...
	public boolean onFling(MotionEvent event1, MotionEvent event2, float velocityX, float velocityY) {
		...
		if (distance < DistanceThreshold) {
			// Was not a fling.
			Log.i(LoggingTag, String.format("Fling distance did not cross swipe threshold (%d). dx: %f, dy: %f.", DistanceThreshold, dx, dy));
			return false;
		}
		...
		return flingHandled || super.onFling(event1, event2, velocityX, velocityY);
	}
