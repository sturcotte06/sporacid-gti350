...
public class FighterDefinitionActivity extends BaseActivity {
	...
	/** */
	public static final String RedFighterKey = "FighterDefinitionActivity_RedFighter";

	/** */
	public static final String BlueFighterKey = "FighterDefinitionActivity_BlueFighter";
	...
	private class IOnNextSwipeListener implements IOnSwipeListener {
		...
		public boolean onSwipe(MotionEvent event1, MotionEvent event2, float velocityX, float velocityY) {
			...
			if (redFighterValid && blueFighterValid) {
				...
				i.putExtra(RedFighterKey, redFighter);
				Log.i(LoggingTag, "Serialized red fighter.");

				i.putExtra(BlueFighterKey, blueFighter);
